...
The server dashboard can now configure options for the mod that are usually set in-game via the menu. This functionality requires a custom version of the mod, which you can get [here](https://github.com/ReznorsRevenge1/smo-practice). (Until I get prebuilds set up you'll need to build it yourself; it's pretty straightforward.)
